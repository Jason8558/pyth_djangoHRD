...
# Кол-ва часов
    hours1 = models.CharField(max_length=7, verbose_name='Часы1', null = True, blank=True)
    hours2 = models.CharField(max_length=7, verbose_name='Часы2', null = True, blank=True)
    hours3 = models.CharField(max_length=7, verbose_name='Часы3', null = True, blank=True)
    hours4 = models.CharField(max_length=7, verbose_name='Часы4', null = True, blank=True)
    hours5 = models.CharField(max_length=7, verbose_name='Часы5', null = True, blank=True)
    hours6 = models.CharField(max_length=7, verbose_name='Часы6', null = True, blank=True)
    hours7 = models.CharField(max_length=7, verbose_name='Часы7', null = True, blank=True)
    hours8 = models.CharField(max_length=7, verbose_name='Часы8', null = True, blank=True)
    hours9 = models.CharField(max_length=7, verbose_name='Часы9', null = True, blank=True)
    hours10 = models.CharField(max_length=7, verbose_name='Часы10', null = True, blank=True)
    hours11 = models.CharField(max_length=7, verbose_name='Часы11', null = True, blank=True)
    hours12 = models.CharField(max_length=7, verbose_name='Часы12', null = True, blank=True)
    hours13 = models.CharField(max_length=7, verbose_name='Часы13', null = True, blank=True)
    hours14 = models.CharField(max_length=7, verbose_name='Часы14', null = True, blank=True)
    hours15 = models.CharField(max_length=7, verbose_name='Часы15', null = True, blank=True)
    hours16 = models.CharField(max_length=7, verbose_name='Часы16', null = True, blank=True)
    hours17 = models.CharField(max_length=7, verbose_name='Часы17', null = True, blank=True)
    hours18 = models.CharField(max_length=7, verbose_name='Часы18', null = True, blank=True)
    hours19 = models.CharField(max_length=7, verbose_name='Часы19', null = True, blank=True)
    hours20 = models.CharField(max_length=7, verbose_name='Часы20', null = True, blank=True)
    hours21 = models.CharField(max_length=7, verbose_name='Часы21', null = True, blank=True)
    hours22 = models.CharField(max_length=7, verbose_name='Часы22', null = True, blank=True)
    hours23 = models.CharField(max_length=7, verbose_name='Часы23', null = True, blank=True)
    hours24 = models.CharField(max_length=7, verbose_name='Часы24', null = True, blank=True)
    hours25 = models.CharField(max_length=7, verbose_name='Часы25', null = True, blank=True)
    hours26 = models.CharField(max_length=7, verbose_name='Часы26', null = True, blank=True)
    hours27 = models.CharField(max_length=7, verbose_name='Часы27', null = True, blank=True)
    hours28 = models.CharField(max_length=7, verbose_name='Часы28', null = True, blank=True)
    hours29 = models.CharField(max_length=7, verbose_name='Часы29', null = True, blank=True)
    hours30 = models.CharField(max_length=7, verbose_name='Часы30', null = True, blank=True)
    hours31 = models.CharField(max_length=7, verbose_name='Часы31', null = True, blank=True)
