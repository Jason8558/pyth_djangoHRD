...
def vacshed_global(request):
    ...
    vacation = list(vacation.values('id', 'emp__department__name' , 'emp__aup__name' ,'emp', 'emp__fullname', 'dur_from', 'dur_to', 'days_count', 'move_from', 'move_to', 'child_year', 'days_count_move', 'city', 'emp__position__name', 'comm').order_by('emp__department__name', 'emp__aup__name', 'emp__fullname', 'dur_from'))
