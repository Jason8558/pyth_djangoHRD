...
from .search import vacshed_global
from . import views
...
path('itemupd/cancelvac/<int:id>', views.vacshed_cancel_vacation, name='vacation_cancel_url'),
...
path('global/new', vacshed_global, name='global_json_new_url'),
