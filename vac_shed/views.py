                ...
                if per != 0:
                    ...
                    if terr == 1:
                        ...
                        if terr == 2:
                            ...
                            if terr == 0:
                                if fil_only == 1:
                                    items = VacantionSheduleItem.objects.filter(bound_shed__year=year).filter(emp__department_id__in=[40,26]).filter(dur_from__month=per).exclude(move_from__isnull=False).values('id', 'emp__department__name' , 'emp__aup__name' , 'emp', 'emp__fullname', 'dur_from', 'dur_to', 'days_count', 'move_from', 'move_to', 'child_year', 'days_count_move', 'city', 'emp__position__name').order_by('emp__department__dir__name', 'emp__department__union__name', 'emp__aup__name', 'emp__department__name',  'emp', 'id', 'dur_from')
                                    ...
                                    if fil_only == 2:
                                        ...
                                        if fil_only == 3:
                                            items = VacantionSheduleItem.objects.filter(bound_shed__year=year).filter(emp__department_id=40).filter(dur_from__month=per).exclude(move_from__isnull=False).values('id', 'emp__department__name' , 'emp__aup__name' , 'emp', 'emp__fullname', 'dur_from', 'dur_to', 'days_count', 'move_from', 'move_to', 'child_year', 'days_count_move', 'city', 'emp__position__name').order_by('emp__department__dir__name', 'emp__department__union__name', 'emp__aup__name', 'emp__department__name',  'emp', 'id', 'dur_from')
                                            ...
                                            items = VacantionSheduleItem.objects.filter(bound_shed__year=year).filter(dur_from__month = per).filter(emp__department__is_filial = 0).values('id', 'emp__department__name' , 'emp__aup__name' ,'emp', 'emp__fullname', 'dur_from', 'dur_to', 'days_count', 'move_from', 'move_to', 'child_year', 'days_count_move', 'city', 'emp__position__name').order_by('emp__department__dir__name', 'emp__department__union__name', 'emp__aup__name', 'emp__department__name',  'emp', 'id', 'dur_from')
